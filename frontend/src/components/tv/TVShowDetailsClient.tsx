    ...
    return (
        <div className="min-h-screen w-full flex flex-col bg-[#0a0904] text-slate-100 font-display pb-20 overflow-x-hidden selection:bg-primary/30 selection:text-white">
                ...
                >
                    ...
                    <motion.div variants={fadeInRight} className="flex flex-wrap items-center gap-4 text-sm md:text-base text-slate-200 font-semibold drop-shadow-md">
                        <div className="flex items-center gap-1.5 text-primary">
                            ...
                            <span className="text-white text-lg">{show.vote_average?.toFixed(1) || '0.0'}</span>
                            <span className="text-sm font-normal text-slate-400">({show.vote_count?.toLocaleString() || 0} reviews)</span>
                        </div>
            ...
            <section className="relative z-20 w-full max-w-7xl mx-auto px-6 lg:px-12 mt-12 lg:-mt-10 grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24">
                ...
                >
                    <h3 className="text-xl font-bold tracking-tight text-white pb-6 border-b border-white/10 uppercase tracking-widest text-sm text-primary">Show Information</h3>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-widest mb-1">Seasons</p>
                            <p className="text-white font-medium text-lg tracking-widest">{show.number_of_seasons}</p>
                        </div>

                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-widest mb-1">Episodes</p>
                            <p className="text-white font-medium text-lg">{show.number_of_episodes}</p>
                        </div>

                        <div>
                            <p className="text-slate-400 text-xs uppercase tracking-widest mb-1">Networks</p>
