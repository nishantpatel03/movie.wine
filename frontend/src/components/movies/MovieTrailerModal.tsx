    ...
    return (
        <>
            ...
            <motion.button
                ...
                className={`flex items-center gap-2 px-8 py-3 lg:px-10 lg:py-4 rounded-xl font-bold transition-all ${isHero ? 'bg-primary text-background-dark shadow-[0_0_20px_rgba(244,192,37,0.4)]' : 'bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-white/20 hover:border-white/40 shadow-[0_0_20px_rgba(255,255,255,0.1)]'}`}
            >
                <Play className="fill-current w-5 h-5" />
                {btnText}
            </motion.button>
