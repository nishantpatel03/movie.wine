        ...
        <section className="px-6 lg:px-12 py-12">
                        ...
                        <Link href={`/movies/${movie.id}`} className="flex flex-col h-full w-full">
                            ...
                            <div className="flex-1 flex flex-col">
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-xs font-bold text-primary tracking-wider uppercase truncate max-w-[60%]">
                                ...
                                <h3 className="text-white font-serif italic text-lg group-hover:text-primary transition-colors line-clamp-2">
                                    {movie.title}
                                </h3>
                            </div>
                        </Link>
            ...
            {filteredMovies.length === 0 && (
                <div className="w-full py-20 text-center text-slate-500">
                    <span className="material-symbols-outlined text-4xl mb-4 block opacity-50">movie_off</span>
                    <p>No magical titles found for this filter right now.</p>
                </div>
            )}
        </section>
    );
